# @taktikangea/excepturi-commodi

[![npm version](https://badge.fury.io/js/@taktikangea/excepturi-commodi.svg)](https://badge.fury.io/js/@taktikangea/excepturi-commodi)
[![downloads count](https://img.shields.io/npm/dt/@taktikangea/excepturi-commodi.svg)](https://www.npmjs.com/package/@taktikangea/excepturi-commodi)
[![github-ci](https://github.com/taktikangea/excepturi-commodi/actions/workflows/testing.yml/badge.svg)](https://github.com/taktikangea/excepturi-commodi/actions/workflows/testing.yml)
...
Next, install `@taktikangea/excepturi-commodi`:

```bash
npm install -D @taktikangea/excepturi-commodi
```
